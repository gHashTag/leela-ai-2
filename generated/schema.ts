...
export class PlayerCreated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PlayerCreated entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PlayerCreated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PlayerCreated", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): PlayerCreated | null {
    return changetype<PlayerCreated | null>(
      store.get_in_block("PlayerCreated", id.toHexString())
    );
  }

  static load(id: Bytes): PlayerCreated | null {
    return changetype<PlayerCreated | null>(
      store.get("PlayerCreated", id.toHexString())
    );
  }
...
export class PlayerUpdated extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PlayerUpdated entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PlayerUpdated must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PlayerUpdated", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): PlayerUpdated | null {
    return changetype<PlayerUpdated | null>(
      store.get_in_block("PlayerUpdated", id.toHexString())
    );
  }

  static load(id: Bytes): PlayerUpdated | null {
    return changetype<PlayerUpdated | null>(
      store.get("PlayerUpdated", id.toHexString())
    );
  }

...
export class PlayerCreated extends ethereum.Event {
  get params(): PlayerCreated__Params {
    return new PlayerCreated__Params(this);
  }
}

export class PlayerCreated__Params {
  _event: PlayerCreated;

  constructor(event: PlayerCreated) {
    this._event = event;
  }
...
export class RollDiceError extends ethereum.Event {
  get params(): RollDiceError__Params {
    return new RollDiceError__Params(this);
  }
}

export class RollDiceError__Params {
  _event: RollDiceError;

  constructor(event: RollDiceError) {
    this._event = event;
  }
...
export class LeelaGame__getPlayerResultValue0Struct extends ethereum.Tuple {
  get fullName(): string {
  ...
  get consecutiveSixes(): i32 {
    return this[7].toI32();
  }

  get positionBeforeThreeSixes(): BigInt {
...
export class LeelaGame__playersResult {
  ...
  getPositionBeforeThreeSixes(): BigInt {
    return this.value8;
  }
}
...
export class LeelaGame extends ethereum.SmartContract {
  ...
  getPlayer(playerAddress: Address): LeelaGame__getPlayerResultValue0Struct {
    let result = super.call(
      "getPlayer",
      "getPlayer(address):((string,string,string,uint256,uint256,bool,bool,uint8,uint256))",
      [ethereum.Value.fromAddress(playerAddress)]
    );

    return changetype<LeelaGame__getPlayerResultValue0Struct>(
      result[0].toTuple()
    );
  }
  ...
  try_getPlayer(
    playerAddress: Address
  ): ethereum.CallResult<LeelaGame__getPlayerResultValue0Struct> {
    let result = super.tryCall(
      "getPlayer",
      "getPlayer(address):((string,string,string,uint256,uint256,bool,bool,uint8,uint256))",
      [ethereum.Value.fromAddress(playerAddress)]
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      changetype<LeelaGame__getPlayerResultValue0Struct>(value[0].toTuple())
    );
  }
  ...
  playerCreated(param0: Address): boolean {
    let result = super.call("playerCreated", "playerCreated(address):(bool)", [
  ...
  try_playerCreated(param0: Address): ethereum.CallResult<boolean> {
    let result = super.tryCall(
      "playerCreated",
      "playerCreated(address):(bool)",
      [ethereum.Value.fromAddress(param0)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  players(param0: Address): LeelaGame__playersResult {
    let result = super.call(
      "players",
      "players(address):(string,string,string,uint256,uint256,bool,bool,uint8,uint256)",
      [ethereum.Value.fromAddress(param0)]
    );
...
export class CreatePlayerCall extends ethereum.Call {
  get inputs(): CreatePlayerCall__Inputs {
    return new CreatePlayerCall__Inputs(this);
  }

  get outputs(): CreatePlayerCall__Outputs {
    return new CreatePlayerCall__Outputs(this);
  }
}

export class CreatePlayerCall__Inputs {
  _call: CreatePlayerCall;

  constructor(call: CreatePlayerCall) {
    this._call = call;
  }
  ...
  get _intention(): string {
    return this._call.inputValues[2].value.toString();
  }
}

export class CreatePlayerCall__Outputs {
  _call: CreatePlayerCall;
...
export class UpdatePlayerCall extends ethereum.Call {
  get inputs(): UpdatePlayerCall__Inputs {
    return new UpdatePlayerCall__Inputs(this);
  }

  get outputs(): UpdatePlayerCall__Outputs {
    return new UpdatePlayerCall__Outputs(this);
  }
}

export class UpdatePlayerCall__Inputs {
  _call: UpdatePlayerCall;

  constructor(call: UpdatePlayerCall) {
    this._call = call;
  }
...
export class UpdatePlayerCall__Outputs {
  _call: UpdatePlayerCall;
